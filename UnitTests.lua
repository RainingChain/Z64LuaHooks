...
assert(Utils.arrayToString({length=2,[1]=12,[2]=8},true) == "[0C,08]")
...
assert(Utils.decToHex(0x803FFDB0) == "803FFDB0)")
assert(tonumber(Utils.decToHex(0x803FFDB0),16) == 0x803FFDB0)
